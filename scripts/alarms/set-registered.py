...
@click.option('--location', type=click.Choice(['INJ', 'NL', 'SL', 'HA', 'HB', 'HC', 'HD','UITF']), help="The alarm location")
@click.option('--category', type=click.Choice(['Aperture','BCM','Dump','Gun','Magnet','RADCON','RF','Safety','Vacuum']), help="The alarm category")
