...
- **Middleware**
   ...
   - *Stream Processors*: 
     ...
     - [jaws-auto-override-processor](https://github.com/JeffersonLab/jaws-auto-override-processor) - Applys and maintains automated overrides based on configuration without manual operator intervention
