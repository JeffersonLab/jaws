...
| suppressed-alarms | Set of alarms that have been suppressed. | AVRO: [suppressed-alarms-key](https://github.com/JeffersonLab/jaws/blob/master/config/subject-schemas/suppressed-alarms-key.avsc) | AVRO: [suppressed-alarms-value](https://github.com/JeffersonLab/jaws/blob/master/config/subject-schemas/suppressed-alarms-value.avsc) | set-suppressed.py, list-suppresed.py |
